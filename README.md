...
- captures planner notes, candidate outputs, reviewer notes, verifier reports, latency, and failure taxonomy
- includes CI, summary JSON, Markdown report generation, and sample run artifacts
